...
public class RiskOfTerrain : Mod {
    ...
    public override void Load() {
        ...
        PriceModifiers = new List<(Func<bool>, float)>()
        {
            ...
            (() => { return NPC.downedBoss1; }, 0.25f), //a staple
            (() => { return NPC.downedBoss2; }, 0.5f), //unlocks npc
            (() => { return NPC.downedBoss3; }, 0.5f), //mandatory
            (() => { return NPC.downedQueenBee; }, 0.1f), //unlocks npc
            //(() => NPC.downedSlimeKing, 0.1f),
            //(() => NPC.downedDeerclops, 0.1f),
            (() => { return Main.hardMode; }, 2f), //wof
            //(() => NPC.downedMechBoss1, 0.5f),
            //(() => NPC.downedMechBoss2, 0.5f),
            //(() => NPC.downedMechBoss3, 0.5f),
            //(() => NPC.downedQueenSlime, 0.1f),
            (() => { return NPC.downedPlantBoss; }, 4f), //planteras important
            (() => { return NPC.downedGolemBoss; }, 0.5f), //impoteran
            //(() => NPC.downedFishron, 0.25f),
            //(() => NPC.downedEmpressOfLight, 0.25f),
            (() => { return NPC.downedAncientCultist; }, 0.25f), //impotent
            (() => { return NPC.downedGoblins; }, 0.1f), //soft mandatory
